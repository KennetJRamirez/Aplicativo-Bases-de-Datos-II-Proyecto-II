...
if(isset($_FILES['csv_file']) && $_FILES['csv_file']['error'] === UPLOAD_ERR_OK && isset($_POST['tabla'])) {
    ...
    switch ($tabla) {
        ...
        case 'carretera_comunidad':
            ...
            break;
        default:
        // En caso no se haya seleccionado una tabla válida, mostrar un mensaje de error y salir del script
    ...
    // Leer la primera fila del archivo CSV para obtener los nombres de las columnas
    fgetcsv($archivo);

    // Recorrer las filas del archivo CSV
    while(($fila = fgetcsv($archivo)) !== false) {
        // Verificar si la fila tiene el formato esperado para la tabla seleccionada
    ...
    // Si no se recibió un archivo CSV o no se seleccionó una tabla, mostrar el formulario para subir un archivo CSV
?>
<!DOCTYPE html>
<html lang="es">
